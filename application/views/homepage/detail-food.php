...
<div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-10 p-l-15-sm">
    ...
    <a href="<?= base_url('homepage/food'); ?>" class="s-text16">
        Food
        <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
    </a>
    <span class="s-text17">
    ...
    <div class="flex-w flex-sb">
        <div class="w-size13 p-t-30 respon5">
            <div class="wrap-slick3 flex-sb flex-w">
                ...
                <div class="slick3">
                    <div class="item-slick3" data-thumb="<?= base_url('assets/img/') ?>product/food/<?= $food->food_image ?>">
                        <div class="wrap-pic-w">
                            <img src="<?= base_url('assets/img/') ?>product/food/<?= $food->food_image ?>" alt="<?= $food->food_name; ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php if ($food->stock !== 'Sold-Out') { ?>
                        <div class="block2-btn-addcart-detail w-size16 flex-m">
                            <div class="add_qty_cart_detail flex-w of-hidden">
                                ...
                                <input class="qty-num-product-detail m-text18 t-center num-product" type="number" name="qty" value="1" id="<?= $food->food_code; ?>">
                                <button class="btn-num-product-up btn-qty-detail colorwhite flex-c-m bg15 eff4">
                                    <i class="fs-12 fa fa-plus" aria-hidden="true"></i>
                                </button>
                            </div>
                            <button class="add-cart add_to_cart_detail flex-c-m sizefull hov7 s-text3 trans-0-4" data-productcode="<?= $food->food_code; ?>" data-productname="<?= $food->food_name; ?>" data-productprice="<?= $fixed_price; ?>" data-action="add">
                                Add to Cart
                            </button>
                        </div>
                    <?php } else { ?>
...
<section class="relateproduct bgwhite p-t-20 p-b-100">
    <div class="container">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                <?php foreach ($food_related as $fr) {
                    $price = $fr->price;
                ...
                ?>
                    <div class="item-slick2 p-l-15 p-r-15">
                        <div class="bo9 bg15 bo-rad-5 block2 pos-relative">
                            ...
                            <?php } ?>
                            <div class="bo9 bo-rad-5 block2-img wrap-pic-w <?= $fr->stock !== 'Sold-Out' ? ' of-hidden' : null ?> pos-relative">
                                <img src="<?= base_url('assets/img/') ?>product/food/<?= $fr->food_image; ?>" alt="<?= $fr->food_name ?>">
                                <?php if ($fr->stock !== 'Sold-Out') { ?>
                                    <div class="block2-overlay trans-0-4">
                                        ...
                                        <div class="block2-btn-addcart-slick w-size30 trans-0-4">
                                            <div class="add_qty_cart_slick flex-w of-hidden">
                                                ...
                                                <input class="qty-num-product-slick m-text18 t-center num-product" type="number" name="quantity" value="1" id="<?= $fr->food_code; ?>">
                                                <button class="btn-num-product-up btn-qty-slick colorwhite flex-c-m bg15 eff4"><i class="fs-12 fa fa-plus" aria-hidden="true"></i>
                                                </button>
                                            </div>
                                            <button class="add-cart add_to_cart_slick flex-c-m hov7 s-text3 trans-0-4" data-productcode="<?= $fr->food_code; ?>" data-productname="<?= $fr->food_name; ?>" data-productprice="<?= $fixed_price; ?>" data-action="add">
                                                Add to Cart
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="block3-txt p-b-10 text-center">
                                <h4>
                                    <a href="<?= base_url('homepage/detail/' . $fr->food_code); ?>" class="block2-product-name">
                                        <?= $fr->food_name ?>
                                    </a>
                                </h4>
                                <?php if ($discount !== '0') { ?>
