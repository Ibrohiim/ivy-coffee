            ...
            <div class="row">
                <div class="col-md-4">
                    <?php foreach ($editcategory as $ec) { ?>
                        <div class="card card-primary">
                            ...
                            <form role="form" action="<?= base_url('drinks/savecategory'); ?>" method="POST">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?= base_url('drinks/categories') ?>">Add new category</a></li>
                    </ul>
