            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?= base_url('drinks/addnewdrink') ?>"><?= $subtitle; ?></a></li>
                    </ul>
                    <div class="card card-primary card-outline">
                        ...
                        <form class="form-horizontal" method="POST" action="<?= base_url('drinks/addnewdrink'); ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="<?= $drink_code; ?>" id="drink_code" class="form-control <?= form_error('drink_name') ? 'is-invalid' : null; ?>" disabled />
                                                <input type="hidden" value="<?= $drink_code; ?>" id="drink_code" name="drink_code" class="form-control <?= form_error('drink_name') ? 'is-invalid' : null; ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" for="drink_name">Drink Name</label>
                                            <div class="col-sm-8">
                                                <input type="text" value="<?= set_value('drink_name'); ?>" name="drink_name" placeholder="Input new drink name" id="drink_name" class="form-control <?= form_error('drink_name') ? 'is-invalid' : null; ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" value="<?= set_value('price'); ?>" name="price" placeholder="Input new drink price" id="price" class="form-control <?= form_error('price') ? 'is-invalid' : null; ?>" />
                                                <?= form_error('price', '<small class="text-danger m-r-10">', '</small>'); ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" for="stock">Drink Stock</label>
                                            <div class="col-sm-8">
